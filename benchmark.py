...
parser.add_argument('--results-file', default='Restnet-200-3072imgs-112size-1gpu.csv', type=str, metavar='FILENAME',
...
parser.add_argument('-b', '--batch-size', default=3072, type=int,
