...
parser.add_argument('--results-file', default='Restnet-200-4700imgs-112size-1gpu.csv', type=str, metavar='FILENAME',
                    help='Output csv file for validation results (summary)')
parser.add_argument('--num-warm-iter', default=10, type=int,
                    metavar='N', help='Number of warmup iterations (default: 10)')
parser.add_argument('--num-bench-iter', default=1000, type=int,
...
parser.add_argument('-b', '--batch-size', default=4700, type=int,
